      ...
      <div>
        ...
        <div className="u-social-icons u-spacing-10 u-social-icons-1">
          ...
          <section className="text-center pt-36 bg-u_section1 bg-cover">
            <h1 className="text-7xl text-purple-600 font-sans font-bold my-10" data-animation-name="slideIn" data-animation-duration="1000" data-animation-direction="Down">SOWFEE</h1>
